...
from src.util import adjust_learning_rate, warmup_learning_rate, accuracy
from src.util import set_optimizer
from src.model import t_SimCLR, LinearClassifier
...
def parse_option():
    ...
    if opt.warm:
        ...
        opt.warmup_from = 0.01 * opt.learning_rate
        opt.warm_epochs = 10
        if opt.cosine:
